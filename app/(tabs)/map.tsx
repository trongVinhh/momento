...
const photoMarkerStyles = StyleSheet.create({
  ...
  image: { 
    width: '100%', 
    height: '100%',
    borderRadius: 17, // Clip image directly as a circle in bitmap rendering
  },
  placeholder: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#2a2a38', borderRadius: 17 },
  tail: {
    width: 0, height: 0,
