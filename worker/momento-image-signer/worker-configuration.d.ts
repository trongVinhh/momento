/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ba674dd6a0d8ad6d2c039d78f235ff93)
// Runtime types generated with workerd@1.20260708.1 2026-07-13 nodejs_compat
interface __BaseEnv_Env {
	SUPABASE_URL: "https://uicwklmejfnsparzvurk.supabase.co";
	SUPABASE_ANON_KEY: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVpY3drbG1lamZuc3Bhcnp2dXJrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODM5MjUxNDksImV4cCI6MjA5OTUwMTE0OX0.-h93uId3XSLftWjEacPHZ60DAu-fBB5ph5JMGpC5y5A";
	R2_ACCOUNT_ID: string;
	R2_ACCESS_KEY_ID: string;
	R2_SECRET_ACCESS_KEY: string;
	R2_PUBLIC_CUSTOM_DOMAIN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "R2_ACCOUNT_ID" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_PUBLIC_CUSTOM_DOMAIN" | "R2_BUCKET_NAME" | "SUPABASE_JWT_SECRET">> {}
}
